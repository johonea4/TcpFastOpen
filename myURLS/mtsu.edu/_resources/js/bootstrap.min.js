...
/*
//BEGIN IMAGE GALLERY GRID HEIGHT CONSISTENCY
$(window).on('load', function() {
	resizeImgGrid();
	$(window).resize(function(){resizeImgGrid()});
});
function resizeImgGrid() {
	var gridHeight = 0;
	$('.image-grid a.fancybox-button').css('min-height','0px');
	if ($(window).width() > 480) {
		$('.image-grid a.fancybox-button').each(function(){
			if ($(this).height() > gridHeight){
				gridHeight = $(this).height();
			}
		});
		$('.image-grid a.fancybox-button').css('min-height',gridHeight+'px');		
	}
}
//END IMAGE GALLERY GRID HEIGHT CONSISTENCY
*/
...
var tempImgGrid;
var toTop = $('<a>').attr('id','filter-top').append('<span class="glyphicon glyphicon-arrow-up"></span>Top'); //</a>
